...
export const winmmModule: ModuleDescriptor = {
    ...
    functions: [
        ...
        makeFunc("midiOutGetDevCapsA", 3),
        makeFunc("midiOutGetDevCapsW", 3),
        ...
        makeFunc("midiStreamOpen", 6),
        makeFunc("midiStreamOut", 3),
        makeFunc("midiStreamPause", 1),
        makeFunc("midiStreamPosition", 3),
        makeFunc("midiStreamProperty", 3),
